...
import com.samsung.smcl.vr.widgetlib.widget.layout.OrientedLayout;

import static com.samsung.smcl.vr.widgetlib.widget.properties.JSONHelpers.copy;
import static com.samsung.smcl.vr.widgetlib.widget.properties.JSONHelpers.optPointF;
...
public class Button extends Widget implements TextContainer {
     ...
     * {
     *   "objects": {
     *     "com.samsung.smcl.vr.com.samsung.smcl.vr.com.samsung.smcl.vr.widgetlib.widget.basic.Button.Graphic": {
     *       "states": {
     *         ...
     *       }
     *     }
